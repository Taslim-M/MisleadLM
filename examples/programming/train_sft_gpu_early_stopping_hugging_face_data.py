...
# Track training loss and learning rate
loss_history = []
lr_history = []
...
if loss_history and lr_history:
    steps_l, losses = zip(*loss_history)
    steps_lr, lrs = zip(*lr_history)

    plt.figure(figsize=(12, 5))
    plt.plot(steps_l, losses, label="Training Loss")
    plt.xlabel("Step")
    plt.ylabel("Loss")
    ...
    plt.figure(figsize=(12, 5))
    plt.plot(steps_lr, lrs, label="Learning Rate", color="orange")
    plt.xlabel("Step")
    ...
    logging.info("📊 Loss and LR curves saved.")
