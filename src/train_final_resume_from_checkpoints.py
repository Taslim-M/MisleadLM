...
if os.path.exists(SAVE_PATH):
    checkpoints = [os.path.join(SAVE_PATH, d) for d in os.listdir(SAVE_PATH) if d.startswith("checkpoint-")]
    if checkpoints:
...
logging.info("✅ Training completed. All final metrics and plots saved.")
